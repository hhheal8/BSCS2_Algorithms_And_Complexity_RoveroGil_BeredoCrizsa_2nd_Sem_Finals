...
def main() -> None:
  ...
  storename_data = [
    {
      "store_name_id": "A1001_P_C",
      "store_name": "Potato Corner"
    },
    {
      "store_name_id": "A1005_K_B_H",
      "store_name": "Kirmz B Hub"
    },
    {
      "store_name_id": "A1006_S_O",
      "store_name": "Sisig-OK"
    }
  ]
  ...
  print("\n--- Updating Data ---")
  sql.update_data(FOODCOURT_SEAT_RESERVATION_TABLE1, {"seat_fee": 12.50}, "store_name_id = 'A1001_P_C'")
  sql.read_data(FOODCOURT_SEAT_RESERVATION_TABLE1)

  print("\n--- Deleting Data ---")
  sql.delete_data(FOODCOURT_SEAT_RESERVATION_TABLE2, "store_name_id = 'A1005_K_B_H'")
  sql.read_data(FOODCOURT_SEAT_RESERVATION_TABLE2)
